      ...
      <Card className="w-full max-w-xl mx-auto mb-4 shadow-lg rounded-2xl">
        ...
        <CardContent className="p-4 space-y-4">
          ...
          <div className="text-sm text-gray-700 space-y-2">
            <p>
              <span className="font-medium">Service:</span> {quote.service.name}
            </p>
            <p className="text-gray-600">{quote.service.description}</p>
            <p>
          ...
          <div className="flex justify-between items-center pt-2 border-t">
            ...
            <span className="font-bold text-lg">₱{quote.service.cost}</span>
          </div>
